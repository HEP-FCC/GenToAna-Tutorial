...
class Analysis():
    ...
    def __init__(self, cmdline_args):
        ...
        self.input_dir = '/eos/project/f/fccsw-web/www/tutorials/gen-to-ana/bnl-cern-2026/delphes/pwp8_pp_hh_5f_hhbbyy'
        ...
        self.test_file = '/eos/project/f/fccsw-web/www/tutorials/gen-to-ana/bnl-cern-2026/delphes/pwp8_pp_hh_5f_hhbbyy/pwp8_pp_hh_5f_hhbbyy.root'
